...
<body>
    <!-- Encabezado -->
    <%@ include file="../Template/AdminEncabezado.jsp" %>
    ...
    <div class="container">
        ...
        <form class="search-form" action="/borabora/admin/catalogobusquedad" method="post">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="card product-card">
                        ...
                        <div class="card-footer product-footer">
                            <a href="/borabora/admin/producto/${producto.productoId}" class="btn btn-info btn-sm">+ Ver más</a>
                        </div>
                    </div>
                </div>
            </c:forEach>
